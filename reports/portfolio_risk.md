...
- Chevron (CVX): cluster=C1, leader=-, max_corr=-0.009 vs Berkshire, risk=-, allowed=❌, waiting=전진검증
...
- 신한지주 (055550.KS): cluster=C4, leader=-, max_corr=0.427 vs 셀트리온, risk=-, allowed=❌, waiting=전진검증
