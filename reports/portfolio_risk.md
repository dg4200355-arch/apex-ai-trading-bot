...
- Caterpillar (CAT): cluster=C5, leader=-, max_corr=-0.046 vs AbbVie, risk=-, allowed=❌, waiting=전진검증
- Berkshire (BRK-B): cluster=C6, leader=-, max_corr=0.386 vs Mastercard, risk=-, allowed=❌, waiting=전진검증
